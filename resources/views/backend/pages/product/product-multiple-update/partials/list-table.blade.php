    ...
    <table id="productListMultipleUpdate" class="table align-middle mb-0 table-hover table-centered">
        <thead class="bg-light-subtle">
            <tr>
                ...
                @elseif ($criteria == 'product-short-description')
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <input type="hidden" name="product_id[]" value="{{ $product->id }}">
                    <div class="mb-0">                        
                        <textarea name="product_short_description[]" class="form-control" rows="3">{{ trim($product->product_short_description) }}</textarea>
                    </div>
                </td>
                @elseif ($criteria == 'product-description')
                <td>
