                            ...
                            <div class="col-lg-4">
                                <div class="dropdown">
                                    <select id="selecte-criteria" class="form-select">
                                        ...
                                        <option value="product-short-description" {{ request('criteria') == 'product-short-description' ? 'selected' : '' }}>
...
<script src="{{asset('backend/assets/js/pages/multiple-update.js')}}?v={{ env('ASSET_VERSION', '1.0') }}"></script>
<script>
    var routes = {
