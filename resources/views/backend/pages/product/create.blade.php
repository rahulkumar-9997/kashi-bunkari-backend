                        ...
                        <div class="row">
                           ...
                           <div class="col-lg-12">
                              <div class="mb-2">
                                 ...
                                 <textarea class="form-control bg-light-subtle" id="meta_description" rows="2" name="meta_description" placeholder="Short description about meta description"></textarea>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="row">
                           <div class="col-lg-12">
                              <div class="mb-2">
                                 ...
                                 <div class="mb-3">                                   
                                    <textarea name="product_description" class="ckeditor4 hidden-textarea"></textarea>
                                 </div>
                              </div>
                           </div>
                        </div>
...
<script>
      ...
      $(document).ready(function() {
         ...
         $(document).on('paste', '.add-more-additional-feature-append .form-control', function (e) {
            ...
            let startRow = $(this).closest('.row');
            lines.forEach((line, index) => {
               let parts = line.trim().split(' ');
               let key = parts.shift();
               let value = parts.join(' ');
               if (index === 0) {
                     fillRow(startRow, key, value);
               } else {
                     additionalFeatureCount++;
                     let newRow = $(`
                        <div class="row" id="additional-feature-row-${additionalFeatureCount}">
                           <div class="col-lg-5">
                                 <div class="mb-2">
                                    <input type="text" name="additional_feature_key[]" class="form-control" placeholder="Enter additional feature key">
                                 </div>
                           </div>
                           <div class="col-lg-5">
                                 <div class="mb-2">
                                    <input type="text" name="additional_feature_key_value[]" class="form-control" placeholder="Enter additional feature key value">
                                 </div>
                           </div>
                           <div class="col-lg-2">
                                 <button type="button" class="btn btn-danger remove-feature btn-sm" data-id="${additionalFeatureCount}">Remove</button>
