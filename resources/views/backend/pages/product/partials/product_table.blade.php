        ...
        <tbody>
            ...
            @foreach($data['product_list'] as $product)
                <tr class="product-row">
                    ...
                    <td>{{ $sr_no++ }}</td>
                    <td>
                        <a href="https://www.google.com/search?q={{ urlencode($product->title) }}&udm=2" target="_blank" class="text-primary fs-15">
                        ...
                        <div class="overflow-auto" style="max-width: 200px; max-height: 100px; overflow: auto; white-space: nowrap;">
                            @if($product->slug)
                                <span class="text-success slug-text-{{ $product->id }}">
                                    {{ $product->slug }}
                                </span>
                            @endif
                        </div>
