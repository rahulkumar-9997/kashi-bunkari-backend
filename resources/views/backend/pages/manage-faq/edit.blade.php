        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center gap-1">
                    <h4 class="card-title flex-grow-1">Edit FAQ</h4>
                    <a href="{{ route('manage-faq.index') }}" data-title="Back to FAQ List"
                        data-bs-toggle="tooltip" title="Back to FAQ List" class="btn btn-sm btn-info">
                        << Back to FAQ List
                    </a>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('manage-faq.update',$faq->id) }}"enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    @if($faq->answer_image)
                                        <div class="mt-2">
                                            <img src="{{ asset('storage/images/faq/'.$faq->answer_image) }}" width="100">
                                        </div>
                                    @endif
                                    @error('faq_image')
                                        <div class="invalid-feedback">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea id="content"
                                            name="content"
                                            class="form-control ckeditorUpdate4 @error('content') is-invalid @enderror">{{ old('content', $faq->answer) }}</textarea>
                                    @error('content')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
