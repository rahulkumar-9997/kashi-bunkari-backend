...
class AttributeController extends Controller
{
    ...
    public function attributesValueEdit(Request $request, $id){        
        $category_list = Category::orderBy('id', 'DESC')->get();
        $attributes_value_id = $id;
        $attributes_id = $request->input('attributes_id', null);
    ...
    public function deletaAttributesValue(Request $request, $id){
        ...
        /* Delete related records from map_attributes_values_to_category */
        MapAttributesValueToCategory::where('attributes_value_id', $id)->delete();
        /* Delete related records from product_attributes_values */ 
        ProductAttributesValues::where('attributes_value_id', $id)->delete();        
        /* Delete related hsn_gst record */
        UpdateHsnGstWithAttributes::where('attributes_value_id', $id)->delete();        
        /* Detach from categories if using many-to-many relationship */ 
        $attributes_value_row->map_attributes_value_to_categories()->detach();
